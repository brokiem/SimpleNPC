...
class SimpleNPC extends PluginBase
{
            ...
            if (in_array(strtolower($decoded["type"]), self::$npcType, true)) {
                ...
                if ($decoded["type"] === self::ENTITY_HUMAN) {
                    $nbt->setTag(new CompoundTag("Skin", [
                            ...
                            "Data" => new ByteArrayTag("Data", in_array(strlen(base64_decode($decoded["skinData"])), Skin::ACCEPTED_SKIN_SIZES, true) ? base64_decode($decoded["skinData"]) : $this->getDefaultSteveSkin())
                        ])
                    );
    ...
    public function getDefaultSteveSkin()
    {
