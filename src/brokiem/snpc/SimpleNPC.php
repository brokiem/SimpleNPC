            ...
            if (in_array(strtolower($decoded["type"]), self::$npcType, true)) {
                ...
                if ($decoded["type"] === self::ENTITY_HUMAN || $decoded["type"] === self::ENTITY_WALKING_HUMAN) {
                    $nbt->setTag(new CompoundTag("Skin", [
                            ...
                            "CapeData" => new ByteArrayTag("CapeData", strlen(base64_decode($decoded["capeData"])) === 8192 ? base64_decode($decoded["capeData"]) : ""),
                            "GeometryName" => new StringTag("GeometryName", $decoded["geometryName"]),
                            "GeometryData" => new ByteArrayTag("GeometryData", base64_decode($decoded["geometryData"]))
                        ])
                    );
