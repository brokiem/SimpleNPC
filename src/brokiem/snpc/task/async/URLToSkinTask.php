...
class URLToSkinTask extends AsyncTask {
    ...
    public function __construct(private string $username, private string $dataPath, private string $skinUrl, CustomHuman $human, private bool $useFallbackSkin = false) {
